...
Todo o conteúdo publicado tem caráter educativo e informativo. **Ele não constitui consulta, diagnóstico, prescrição ou tratamento** e não substitui a orientação individual de médicos, nutricionistas ou outros profissionais de saúde.

Necessidades nutricionais variam conforme idade, sexo, histórico clínico, uso de medicamentos, exames e objetivos. Nenhuma recomendação geral publicada aqui considera o seu caso específico.
...
Artigos citam fontes científicas e podem apontar para sites de terceiros. Não temos controle sobre o conteúdo, a disponibilidade ou as práticas de privacidade desses sites.

## Alterações

Estes termos podem ser atualizados a qualquer momento. A data de atualização aparece no topo desta página.

## Foro

Fica eleito o foro da comarca de domicílio do responsável pelo site para dirimir questões decorrentes destes termos.
